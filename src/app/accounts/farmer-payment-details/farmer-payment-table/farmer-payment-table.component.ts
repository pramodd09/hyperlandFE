...
@Component({
  selector: 'app-farmer-payment-table',
  templateUrl: './farmer-payment-table.component.html',
  styleUrls: ['./farmer-payment-table.component.scss'],
  // encapsulation:ViewEncapsulation.None
})
export class FarmerPaymentTableComponent implements OnChanges {
